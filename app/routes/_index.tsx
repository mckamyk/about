...
export const meta: MetaFunction = () => {
  return [
    { title: "McKamyk" },
    { name: "description", content: "Full Stack Engineer" },
  ];
};
    ...
    <main className="flex min-h-screen w-full flex-col items-center gap-4 text-gray-300 pb-48">
      ...
      <div className="flex min-h-screen w-full flex-col items-center gap-4 z-10 max-w-[1200px]">
        ...
        <div className="space-y-8">
                ...
                <div className="col-span-2 xl:col-span-1 flex flex-col gap-y-4 justify-between">
                  ...
                  <div className="text-lg font-semibold text-center">
                    <p className="text-center">
                      Technique to embed multiple react-like components inside
                      an unowned DOM that supports Custom Elements.
                    </p>
                  </div>
          ...
          <Card className="max-w-[1200px]">
            <CardHeader>Forbidden Full Stack</CardHeader>
            <CardBody>
          ...
          <Card className="max-w-[1200px]">
            <CardHeader>Web3 Self-Attested Credit Score</CardHeader>
            <CardBody>
              <div className="grid grid-cols-2 justify-center items-center w-full max-w-[1200px] gap-4 px-2 xl:px-0">
                ...
                <div className="col-span-2 xl:col-span-1 self-stretch flex flex-col justify-around">
                  ...
                  <p className="text-center">
                    DeFi Credit scoring application that allows users to
                    self-attest their credit scores. The credit scores are
                    calculated on Loan data sourced from TheGraph and posted
                    with a small stake on chain. If there are no challenges,
                    within the optmistic window, the user can reclaim their
                    stake. During the optimistic window, validators can check
                    the calculation to assure the user did not lie.
                  </p>

                  <p className="text-center">
                    My responsiblities included the overall architecture and
                    implementation of the Gelato Web3 Functions, Frontend,
                    Algorithm compilation, IPFS node hosting and pinning, and
                    DApp deployment.
                  </p>
                </div>
              </div>
